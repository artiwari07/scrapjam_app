...
To run our program locally, you must change all occurences of the backend and front end deployed link to [localhost 3000](http://localhost:3000/) and [local host 8000](http://localhost:8000/)
